...
## Golang
I did not make a seperate github repository for my own eulerlib for Golang. Therefor the folder "eulerlib" needs to be downloaded and put into "C:\Program Files\Go\src".
